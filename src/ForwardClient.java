...
public class ForwardClient
{
    ...
    private static void doHandshake() throws IOException, CertificateException, InvalidKeyException, NoSuchAlgorithmException, NoSuchProviderException, SignatureException, NoSuchPaddingException, BadPaddingException, IllegalBlockSizeException, InvalidKeySpecException {
        ...
        handshake.setAndSendClientHello(arguments.get("usercert"), socket);
        handshake.setAndSendForwardMessage(arguments.get("targethost"), arguments.get("targetport"), arguments.get("cacert"), socket);
     ...
     */
    static public void startForwardClient() throws IOException, CertificateException, NoSuchAlgorithmException, NoSuchPaddingException, BadPaddingException, SignatureException, NoSuchProviderException, InvalidKeyException, IllegalBlockSizeException, InvalidKeySpecException {
